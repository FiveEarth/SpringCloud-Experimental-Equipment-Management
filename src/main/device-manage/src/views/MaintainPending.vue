<template>
  <div class="page">
    <header class="page-header">
      ...
      <p class="page-desc">接单后可在本列表完成维修并填写成本；超过 24 小时未接单将显示在下方提醒中。</p>
    </header>
    ...
    <el-card class="list-card" shadow="hover">
      ...
      <el-table :data="filteredList" class="page-table table-hover-actions" border style="width: 100%" empty-text="暂无维修记录">
      ...
      <el-table-column label="操作" width="280" fixed="right" align="center">
        <template #default="{ row }">
          ...
          <el-button v-if="row.progressStatus === 1" size="small" type="danger" @click="complete(row, false)">无法修复</el-button>
        </template>
      </el-table-column>
    </el-table>
      </div>
    ...
    <el-dialog v-model="completeVisible" :title="completeSuccess ? '修复完成' : '无法修复（转报废）'" width="440px">
...
export default {
  ...
  methods: {
    ...
    async submitComplete() {
      try {
        await axios.post(`/api/maintain/maintain/${this.completeRow.id}/complete`, {
